  ...
  module America
    def self.find_country_by_name(name)
      constants.each do |country|
        american_country_class = "Kountries::America::#{country}".constantize
    ...
    def self.find_country_by_code(code)
      return empty_struct unless Kountries::America.constants.include?(code.to_sym)

      american_country_class = "Kountries::America::#{code}".constantize
    ...
    class DO
      ...
      UN_OFFICIAL_NAMES = ['Dominican Republic', 'Dominikanische Republik', 'République Dominicaine', 'República Dominicana', 'ドミニカ共和国',
    ...
    class VG
      ...
      UN_OFFICIAL_NAMES = ['British Virgin Islands', 'Britische Jungferninseln', 'Îles Vierges britanniques',
                           'Islas Vírgenes del Reino Unido', 'イギリス領ヴァージン諸島', 'Britse Maagdeneilanden', 'Virgin Islands (British)'].freeze
    end
    ...
    class UM
      ...
      UN_OFFICIAL_NAMES = ['United States Minor Outlying Islands', 'US-Amerikanische Hoheitsgebiete', 'Dépendances américaines',
                           'Islas menores de Estados Unidos', '合衆国領有小離島', 'Kleine afgelegen eilanden van de Verenigde Staten'].freeze
    end
    ...
    class US
      ...
      UN_OFFICIAL_NAMES = ['United States', 'Murica', 'Vereinigte Staaten von Amerika', 'États-Unis', 'Estados Unidos', 'アメリカ合衆国',
    ...
    class PM
      ...
      UN_OFFICIAL_NAMES = ['Saint Pierre and Miquelon', 'Saint-Pierre und Miquelon', 'Saint-Pierre-et-Miquelon', 'San Pedro y Miquelón',
    ...
    class KY
      ...
      COUNTRY_CODE = '1'
      NAME = 'Cayman Islands'
      UN_OFFICIAL_NAMES = ['Cayman Islands', 'Kaimaninseln', 'Îles Caïmans', 'Islas Caimán', 'ケイマン諸島', 'Caymaneilanden'].freeze
    end
    ...
    class TT
      ...
      UN_OFFICIAL_NAMES = ['Trinidad and Tobago', 'Trinidad und Tobago', 'Trinité et Tobago', 'Trinidad y Tobago', 'トリニダード・トバゴ',
    ...
    class KN
      ...
      UN_OFFICIAL_NAMES = ['Saint Kitts and Nevis', 'Föderation St. Kitts und Nevis', 'Saint Kitts et Nevis', 'Saint Kitts y Nevis',
                           'セントクリストファー・ネイビス', 'Saint Kitts en Nevis', 'St. Kitts and Nevis', 'St Kitts and Nevis'].freeze
    end
    ...
    class VC
      ...
      UN_OFFICIAL_NAMES = ['Saint Vincent and the Grenadines', 'Saint Vincent und die Grenadinen', 'Saint-Vincent et les Grenadines',
                           'San Vicente y Granadinas', 'セントビンセントおよびグレナディーン諸島', 'Saint Vincent en de Grenadines',
    ...
    class TC
      ...
      UN_OFFICIAL_NAMES = ['Turks and Caicos Islands', 'Turks- und Caicosinseln', 'Îles Turks et Caïcos', 'Islas Turks y Caicos',
                           'タークス・カイコス諸島', 'Turks- en Caicoseilanden', 'Turks and Caicos'].freeze
    end
    ...
    class AG
      ...
      UN_OFFICIAL_NAMES = ['Antigua and Barbuda', 'Antigua und Barbuda', 'Antigua et Barbuda', 'Antigua y Barbuda', 'アンティグア・バーブーダ',
    ...
    class GS
      ...
      UN_OFFICIAL_NAMES = ['South Georgia', 'South Georgia and the South Sandwich Islands', 'Südgeorgien und die Südlichen Sandwichinseln',
    ...
    class VI
      ...
      UN_OFFICIAL_NAMES = ['Virgin Islands of the United States', 'Amerikanische Jungferninseln', 'Îles Vierges américaines',
                           'Islas Vírgenes de los Estados Unidos', 'アメリカ領ヴァージン諸島', 'Amerikaanse Maagdeneilanden',
