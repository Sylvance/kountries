  ...
  module Asia
    def self.find_country_by_name(name)
      constants.each do |country|
        asian_country_class = "Kountries::Asia::#{country}".constantize
    ...
    def self.find_country_by_code(code)
      return empty_struct unless Kountries::Asia.constants.include?(code.to_sym)

      asian_country_class = "Kountries::Asia::#{code}".constantize
    ...
    class AE
      ...
      UN_OFFICIAL_NAMES = ['United Arab Emirates', 'الإمارات العربية المتحدة', 'Vereinigte Arabische Emirate', 'Émirats Arabes Unis',
                           'Emiratos Árabes Unidos', 'アラブ首長国連邦', 'Verenigde Arabische Emiraten'].freeze
    end
    ...
    class IR
      ...
      UN_OFFICIAL_NAMES = ['Iran', 'Irán', 'Iran (Islamic Republic Of)', 'イラン・イスラム共和国', 'Islamic Republic of Iran'].freeze
    end
    ...
    class SA
      ...
      COUNTRY_CODE = '966'
      NAME = 'Saudi Arabia'
      UN_OFFICIAL_NAMES = ['Saudi Arabia', 'Kingdom of Saudi Arabia', 'السعودية', 'Saudi-Arabien', 'Arabie Saoudite', 'Arabia Saudí',
                           'サウジアラビア', 'Saoedi-Arabië'].freeze
    end
    ...
    class KR
      ...
      UN_OFFICIAL_NAMES = ['South Korea', 'Korea (South)', 'Südkorea', 'Corée du Sud', 'Corea del Sur', '大韓民国', 'Zuid-Korea',
    ...
    class PS
      ...
      UN_OFFICIAL_NAMES = ['Palestine', 'فلسطين', 'Palästina', 'Palestina', 'the Occupied Palestinian Territory', 'パレスチナ',
    ...
    class TL
      ...
      COUNTRY_CODE = '670'
      NAME = 'Timor-Leste'
      UN_OFFICIAL_NAMES = ['East Timor', 'Timor-Leste', 'Timor oriental', 'Timor Oriental', '東ティモール', 'Oost-Timor'].freeze
    end
    ...
    class KP
      ...
      UN_OFFICIAL_NAMES = ['Korea (North)', 'North Korea', 'Nordkorea', 'Corée du Nord', 'Corea del Norte', '朝鮮民主主義人民共和国', 'Noord-Korea',
                           "Korea Democratic People's Republic", 'Korea (Democratic People s Republic of)'].freeze
    end
