  ...
  module Europe
    def self.find_country_by_name(name)
      constants.each do |country|
        european_country_class = "Kountries::Europe::#{country}".constantize
    ...
    def self.find_country_by_code(code)
      return empty_struct unless Kountries::Europe.constants.include?(code.to_sym)

      european_country_class = "Kountries::Europe::#{code}".constantize
    ...
    class NL
      ...
      COUNTRY_CODE = '31'
      NAME = 'Netherlands'
      UN_OFFICIAL_NAMES = ['Netherlands', 'The Netherlands', 'Niederlande', 'Pays-Bas', 'Países Bajos', 'オランダ', 'Nederland'].freeze
    end
    ...
    class MK
      ...
      UN_OFFICIAL_NAMES = ['Macedonia', 'Mazedonien', 'Macédoine', 'F.Y.R.O.M (Macedonia)', 'マケドニア旧ユーゴスラビア共和国', 'Macedonië [FYROM].freeze',
                           'Macedonia (The Former Yugoslav Republic of)', 'North Macedonia'].freeze
    end
    ...
    class GB
      ...
      UN_OFFICIAL_NAMES = ['United Kingdom', 'The United Kingdom', 'Vereinigtes Königreich', 'Royaume-Uni', 'Reino Unido', 'イギリス',
                           'Verenigd Koninkrijk', 'Great Britain (UK)', 'UK', 'Великобритания', 'England', 'Scotland', 'Wales',
                           'Northern Ireland', 'Great Britain'].freeze
    end
    ...
    class CZ
      ...
      COUNTRY_CODE = '420'
      NAME = 'Czech Republic'
      UN_OFFICIAL_NAMES = ['Czech Republic', 'Tschechische Republik', 'République Tchèque', 'República Checa', 'チェコ', 'Tsjechië',
                           'Czechia'].freeze
    end
    ...
    class VA
      ...
      COUNTRY_CODE = '39'
      NAME = 'Holy See'
      UN_OFFICIAL_NAMES = ['Vatican City', 'Vatikan', 'Cité du Vatican', 'Ciudad del Vaticano', 'バチカン市国', 'Vaticaanstad',
                           'Vatican City State (Holy See)'].freeze
    end
    ...
    class SJ
      ...
      UN_OFFICIAL_NAMES = ['Svalbard and Jan Mayen', 'Svalbard und Jan Mayen', 'Îles Svalbard et Jan Mayen', 'Islas Svalbard y Jan Mayen',
                           'スヴァールバル諸島およびヤンマイエン島', 'Svalbard en Jan Mayen'].freeze
    end
    ...
    class MD
      ...
      UN_OFFICIAL_NAMES = ['Moldova', 'Moldawien', 'Moldavie', 'Moldavia', 'the Republic of Moldova', 'モルドバ共和国', 'Moldavië'].freeze
    end
    ...
    class BA
      ...
      UN_OFFICIAL_NAMES = ['Bosnia and Herzegovina', 'Bosnien und Herzegowina', 'Bosnie et Herzégovine', 'Bosnia y Herzegovina',
    ...
    class GG
      ...
      COUNTRY_CODE = '44'
      NAME = 'Guernsey'
      UN_OFFICIAL_NAMES = ['Guernsey and Alderney', 'Guernsey und Alderney', 'Guernsey et Alderney', 'Guernsey y Alderney', 'ガーンジー',
                           'Guernsey'].freeze
    end
