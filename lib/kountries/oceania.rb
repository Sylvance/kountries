  ...
  module Oceania
    def self.find_country_by_name(name)
      constants.each do |country|
        ocenia_country_class = "Kountries::Oceania::#{country}".constantize
    ...
    def self.find_country_by_code(code)
      return empty_struct unless Kountries::Oceania.constants.include?(code.to_sym)

      ocenia_country_class = "Kountries::Oceania::#{code}".constantize
    ...
    class PG
      ...
      UN_OFFICIAL_NAMES = ['Papua New Guinea', 'Papua-Neuguinea', 'Papouasie Nouvelle-Guinée', 'Papúa Nueva Guinea', 'パプアニューギニア',
                           'Papoea-Nieuw-Guinea'].freeze
    end
    ...
    class PF
      ...
      UN_OFFICIAL_NAMES = ['French Polynesia', 'Französisch-Polynesien', 'Polynésie Française', 'Polinesia Francesa', 'フランス領ポリネシア',
                           'Frans-Polynesië'].freeze
    end
    ...
    class NF
      ...
      COUNTRY_CODE = '672'
      NAME = 'Norfolk Island'
      UN_OFFICIAL_NAMES = ['Norfolk Island', 'Norfolkinsel', 'Île de Norfolk', 'Isla de Norfolk', 'ノーフォーク島', 'Norfolkeiland'].freeze
    end
    ...
    class MH
      ...
      UN_OFFICIAL_NAMES = ['Marshall Islands', 'Marshallinseln', 'Îles Marshall', 'Islas Marshall', 'マーシャル諸島', 'Marshalleilanden'].freeze
    end
    ...
    class NC
      ...
      COUNTRY_CODE = '687'
      NAME = 'New Caledonia'
      UN_OFFICIAL_NAMES = ['New Caledonia', 'Neukaledonien', 'Nouvelle-Calédonie', 'Nueva Caledonia', 'ニューカレドニア', 'Nieuw-Caledonië'].freeze
    end
    ...
    class MP
      ...
      UN_OFFICIAL_NAMES = ['Northern Mariana Islands', 'Nördliche Marianen', 'Mariannes du Nord', 'Islas Marianas del Norte', '北マリアナ諸島',
    ...
    class NZ
      ...
      COUNTRY_CODE = '64'
      NAME = 'New Zealand'
      UN_OFFICIAL_NAMES = ['New Zealand', 'Neuseeland', 'Nouvelle Zélande', 'Nueva Zelanda', 'ニュージーランド', 'Nieuw-Zeeland'].freeze
    end
    ...
    class SB
      ...
      UN_OFFICIAL_NAMES = ['Solomon Islands', 'Salomonen', 'Îles Salomon', 'Islas Salomón', 'ソロモン諸島', 'Salomonseilanden'].freeze
    end
